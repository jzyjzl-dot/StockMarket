...
hoistedDependencies:
  ...
  '@vitejs/plugin-vue@5.2.4(vite@5.4.19(@types/node@20.19.11))(vue@3.5.21(typescript@5.9.2))':
  ...
  element-plus@2.11.1(vue@3.5.21(typescript@5.9.2)):
  ...
  packages/backend:
    '@stock-market/backend': private
  packages/frontend:
    '@stock-market/frontend': private
  packages/shared:
    '@stock-market/shared': private
  packages/ui:
    '@stock-market/ui': private
  parent-module@1.0.1:
...
pendingBuilds: []
prunedAt: Fri, 05 Sep 2025 02:23:06 GMT
publicHoistPattern:
  - '*eslint*'
  - '*prettier*'
registries:
...
virtualStoreDir: D:\yc\StockMarket\node_modules\.pnpm
